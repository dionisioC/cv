...
\textit{Software Engineer} \hfill July 2021 | Present\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
\item Backend developer using kotlin, micronaut and postgresql.
\item Learn and use good development practices in an agile environment.
\end{itemize}
