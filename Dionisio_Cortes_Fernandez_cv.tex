...
\begin{center}
	...
	$\cdot$ \includegraphics[totalheight=0.4cm]{images/Octocat} \url{https://github.com/dionisioC} $\cdot$ \includegraphics[totalheight=0.4cm]{images/gmail} cortesfernandezdionisio@gmail.com\\$\cdot$ \includegraphics[totalheight=0.3cm]{images/linkedin-icon} \url{https://www.linkedin.com/in/dionisio-cortes-fernandez/?locale=en\_US}\\
\end{center}
